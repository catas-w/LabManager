...
urlpatterns = [
    ...
    path("home/myprofile/reset-passwd/", views.reset_passwd),
    ...
    path("order/add-items/", views.add_foreign_key_items),    
    path("order/myorder/<int:order_id>/", views.order_detail),
    path("order/check/", views.unchecked_order, name="unchecked_list"),
